...
<head>
    ...
    <link rel="apple-touch-icon" href="/ghmc/resources/app-assets/images/ico/apple-icon-120.html">
    ...
    <link rel="stylesheet" type="text/css" href="/ghmc/resources/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
       ...
       <form id="addUserForm" class="auth-login-form mt-2" action="<%=request.getContextPath() %>/login" method="post" class="form-horizontal" role="form" >
        
         <div class="mb-1">
              <label class="form-label" for="basic-addon-name">Name</label>

              <input type="text" id="basic-addon-name"   name="user_name" class="form-control" placeholder="Name" aria-label="Name" aria-describedby="basic-addon-name" required="">
    ...
    <!-- BEGIN: Page JS-->
    <script src="/ghmc/resources/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
