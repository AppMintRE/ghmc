    ...
    <div class="app-content content ">
      ...
      <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-header-left col-md-9 col-12 mb-2">
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">User Masters
                    </li>
                  </ol>
                </div>
              </div>
           ...
           <div class="col-lg-12 col-sm-12 col-12 mb-2"style="
    display: flex;
    align-items: end;
	">																				<!-- 	onclick="exportGHMC();" -->
   <a type="button" class="btn " onclick="addBox();" class="btn btn-gradient-primary mb-2" data-bs-toggle="modal" data-bs-target="#addUser"style=" color: white !important; background-color: blue !important;"><i class="fa fa-add" aria-hidden="true"></i>Add Members</a>
			...
			$.ajax({url : "<%=request.getContextPath()%>/ajax/getUserList",type:"POST",data:myParams,success : function(data){    				
					if(data != null && data != '' && data.length > 0){    					
		         		$.each(data,function(key,val){
		         			var user_data = "'"+val.user_id+"','"+val.role+"','"+val.status+"','"+val.user_name+"'";
		                    var actions = '<a href="javascript:void(0);"  onclick="getUser('+user_data+');" class="btn btn-icon btn-primary waves-effect waves-float waves-light "  title="Edit"><i class="fa fa-pencil"></i></a>';    	                   	
		                   	var rowArray = [];    	                 
		                   	key++;
		                   	rowArray.push(key++);  
		                	rowArray.push($.trim(actions));  
		                	rowArray.push( val.user_name);
		                
		                 	rowArray.push($.trim(val.role));
